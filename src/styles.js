...
export const SHADOW_CSS = `
    ...
    * { box-sizing: border-box; font-family: system-ui, sans-serif; }
    ...
    .sidebar-header button { background: none; border: none; color: #e6e6e6; font-size: 20px; cursor: pointer; }
    ...
    .section-label { font-size: 11px; text-transform: uppercase; opacity: 0.6; margin-bottom: 6px; }
    .chips { display: flex; flex-wrap: wrap; gap: 5px; margin-bottom: 6px; }
    .chip {
      background: #2c3444; border-radius: 12px; padding: 2px 9px; font-size: 12px;
    ...
    .annot-note { font-size: 12px; opacity: 0.85; margin-top: 5px; font-style: italic; }
    .annot-tags { margin-top: 6px; display: flex; flex-wrap: wrap; gap: 4px; }
    .orphan-tag { font-size: 11px; color: #ffb86b; margin-top: 5px; }
    .empty { opacity: 0.6; font-size: 13px; padding: 12px; text-align: center; }
    ...
    .footer-notice {
      ...
      font-size: 12px; line-height: 1.45; color: #ffb86b;
    }
    ...
    .notice-close {
      ...
      width: 20px; height: 20px; line-height: 1; padding: 0;
      border: none; border-radius: 4px; background: transparent;
      color: #9aa4bf; font-size: 15px; cursor: pointer;
    }
    ...
    .footer-warn { font-size: 12px; line-height: 1.45; color: #ffb86b; }
    ...
    .reconcile-title { font-weight: 600; font-size: 14px; color: #ffb86b; }
    .reconcile-body { font-size: 12.5px; line-height: 1.5; color: #e6e6e6; }
    ...
    .sidebar-tab {
      ...
      cursor: pointer; font-size: 16px; z-index: 2147483646;
